...
//        FrameLayout flCode = (FrameLayout) findViewById(R.id.flCode);
                ...
                case REQUEST_CODE:
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            final Result result = decoder.getRawResult(img);
...
//        beepManager.playBeepSoundAndVibrate();
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                Intent dateIntent = new Intent();
                dateIntent.putExtra("DATA", ResultParser.parseResult(rawResult).toString());
                setResult(RESULT_OK, dateIntent);
