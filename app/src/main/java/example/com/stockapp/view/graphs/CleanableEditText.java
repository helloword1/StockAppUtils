...
public class CleanableEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    private CallBackForTextChange callBackForTextChange;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_UP:
                ...
                LogUtils.d(getClass(), "isClean = " + isClean);
                if (isClean) {
                    setText("");
                }
                break;
    ...
    public void setCallBackForTextChange(CallBackForTextChange callBack) {
        this.callBackForTextChange = callBack;
    }

    public interface CallBackForTextChange {
        void textChange();
    }
